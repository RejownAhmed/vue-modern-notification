...
var A = {
  ...
  setup(t, { expose: i }) {
    const o = t, s = ref(0), h2 = ref(0), l = ref(false), d = computed(() => {
      const e = {};
      return l.value && (o.color ? (e["--color-background"] = `var(--color-${o.color})`, o.color === "light" ? e["--color-text"] = "var(--color-dark)" : e["--color-text"] = "var(--color-light)", o.flat && o.color !== "light" && (e["--color-text"] = `var(--color-${o.color})`)) : (e["--color-text"] = "var(--color-dark)", e["--color-background"] = "var(--color-light)"), typeof o.border != "boolean" ? e["--color-border"] = `var(--color-${o.border})` : o.border && (e["--color-border"] = "var(--color-dark)")), e;
    }), f = (e) => {
      o.onClick && o.onClick(e), o.closeOnClick && p();
    };
    function p() {
      l.value = false, o.onClose && o.onClose(evt);
    }
    const n = (e) => {
      s.value = e;
    };
    ...
    return watch(() => o.showProgress, () => {
      o.showProgress && o.duration !== false && (h2.value = setInterval(() => {
        s.value++;
      }, o.duration / 100));
    }, { immediate: true }), onMounted(() => {
      l.value = true;
    }), onBeforeUnmount(() => {
      clearInterval(h2.value);
    }), i({
      close: p,
      changeProgress: n
      ...
      default: withCtx(() => [
        l.value ? (openBlock(), createElementBlock("div", {
          ...
          style: normalizeStyle({ ...d.value, width: o.width }),
          onClick: f
        }, [
...
function a(t) {
  ...
  if (s.style.width = "100%", t.classNotification && s.classList.add(t.classNotification), r.colors) {
    const d = r.colors;
    Object.keys(d).forEach((f) => {
      s.style.setProperty(`--color-${f}`, `${d[f][0]} ${d[f][1]} ${d[f][2]}`);
    });
  }
  const h2 = h(A, i);
  render(h2, s), o.appendChild(s);
  const l = h2.component;
  return t.sticky || i.duration && setTimeout(() => {
    l.exposed.close();
  }, i.duration), l.exposed;
}
function J() {
  let t;
  return {
    primary: (n = {}) => {
      n.color = "primary", t = a(n);
    },
    // Call methods
    secondary: (n = {}) => {
      n.color = "secondary", t = a(n);
    },
    // Call methods
    success: (n = {}) => {
      n.color = "success", t = a(n);
    },
    // Call methods
    warning: (n = {}) => {
      n.color = "warning", t = a(n);
    },
    // Call methods
    error: (n = {}) => {
      n.color = "danger", t = a(n);
    },
    // Call methods
    dark: (n = {}) => {
      n.color = "dark", t = a(n);
